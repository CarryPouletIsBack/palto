...
const DEMO_RIDES: DemoRide[] = [
  {
    id: 'flow-settle-1',
    route: 'Le Tampon → Saint-Pierre',
    date: '4 mai 2026',
    dateEn: '4 May 2026',
    status: 'À régler (espèces)',
    statusEn: 'Pay driver (cash)',
    pickupLabel: 'Le Tampon — centre-ville',
    dropoffLabel: 'Saint-Pierre — front de mer',
    departTime: '11:40',
    arriveTime: '12:18',
    durationMin: 38,
    distanceKm: 28,
    priceEur: 36,
    driverName: 'Marc T.',
    vehicleLabel: 'Piaggio MP3',
    paymentMethod: 'Espèces',
    paymentMethodEn: 'Cash',
    reference: 'TM-2026-0504-SET',
    flow: 'end_cash',
  },
  {
    id: '1',
    route: 'Le Port → Saint-Denis',
    date: '28/04/2026',
    status: 'Terminée',
    pickupLabel: 'Le Port — Avenue de la République',
    dropoffLabel: 'Saint-Denis — Préfecture',
    departTime: '08:12',
    arriveTime: '08:41',
    durationMin: 29,
    distanceKm: 18,
    ...
    paymentMethod: 'Carte',
    reference: 'TM-2026-04128-01',
  },
  {
    id: '2',
    route: 'Saint-Pierre → Étang-Salé',
    date: '22/04/2026',
    status: 'Terminée',
    pickupLabel: 'Saint-Pierre — Rue Marius et Ary Leblond',
    dropoffLabel: 'Étang-Salé — Bord de mer',
    departTime: '18:45',
    arriveTime: '19:22',
    durationMin: 37,
    distanceKm: 22,
    priceEur: 31,
    driverName: 'Sophie R.',
    vehicleLabel: 'Honda Forza',
    paymentMethod: 'Espèces',
    reference: 'TM-2026-04122-02',
  },
  {
    id: '3',
    route: 'Saint-Denis → Roland Garros',
    date: '15/04/2026',
    status: 'Annulée',
    pickupLabel: 'Saint-Denis — Barachois',
    dropoffLabel: 'Aéroport Roland Garros — Terminal Ouest',
    departTime: '06:30',
    arriveTime: '—',
    durationMin: 0,
    distanceKm: 0,
    ...
    vehicleLabel: '—',
    paymentMethod: '—',
    reference: 'TM-2026-04115-03',
  },
  {
    id: '4',
    route: 'La Possession → Le Tampon',
    date: '10/04/2026',
    status: 'Terminée',
    pickupLabel: 'La Possession — ZAC',
    dropoffLabel: 'Le Tampon — 14e km',
    departTime: '12:05',
    arriveTime: '12:58',
    durationMin: 53,
    distanceKm: 34,
    ...
    vehicleLabel: 'Piaggio MP3',
    paymentMethod: 'Carte',
    reference: 'TM-2026-04110-04',
  },
  {
    id: '5',
    route: 'Saint-Leu → Saint-Paul',
    date: '02/04/2026',
    status: 'Terminée',
    pickupLabel: 'Saint-Leu — Hôtel de ville',
    dropoffLabel: 'Saint-Paul — Marina',
    departTime: '09:20',
    arriveTime: '09:48',
    durationMin: 28,
    distanceKm: 15,
    priceEur: 21,
    driverName: 'Julie P.',
    vehicleLabel: 'Yamaha XMAX',
    paymentMethod: 'Indifférent (espèces)',
    reference: 'TM-2026-04002-05',
  },
  {
    id: '6',
    route: 'Saint-Benoît → Bras-Panon',
    date: '18/03/2026',
    status: 'En cours',
    pickupLabel: 'Saint-Benoît — Gare routière',
    dropoffLabel: 'Bras-Panon — Centre',
    departTime: '14:10',
    arriveTime: '14:35 (estimé)',
    durationMin: 25,
    distanceKm: 12,
    priceEur: 19,
    driverName: 'Alain V.',
    vehicleLabel: 'Yamaha TMAX',
    paymentMethod: 'Carte',
    reference: 'TM-2026-0318-06',
  },
];

const WALLET_DEMO_MOVEMENTS = [
  { id: 'w1', date: '28/04/2026', amountCents: -2400, labelKey: 'clientAccount.walletMov1' as const },
  { id: 'w2', date: '25/04/2026', amountCents: 2000, labelKey: 'clientAccount.walletMov2' as const },
  { id: 'w3', date: '22/04/2026', amountCents: -3100, labelKey: 'clientAccount.walletMov3' as const },
];
