...
const PROJECT_H1_CALIGRAPH_PATHS: string[] = [
...
const GLYPH_COUNT = PROJECT_H1_CALIGRAPH_PATHS.length;
...
export interface PaltoH1HandwritingLogoProps {
  className?: string;
 ...
 */
const PaltoH1HandwritingLogo: FC<PaltoH1HandwritingLogoProps> = ({ className, scrollContainerRef }) => {
  ...
  if (reduceMotion) {
    return (
      <div ref={rootRef} className={className}>
        ...
        >
          {PROJECT_H1_CALIGRAPH_PATHS.map((d, i) => (
...
export default PaltoH1HandwritingLogo;
