...
const TRANSLATIONS: Record<Language, Record<string, unknown>> = {
  fr: {
    ...
    project: {
      ...
      contrastTitle:
        "En approfondissant la compréhension du contexte d'utilisation, nous avons réalisé que nous nous étions trop concentrés sur la création et le déroulement des ateliers. Cette approche s'est révélée incomplète.",
  ...
  en: {
    ...
    project: {
      ...
      contrastTitle:
        "By deepening our understanding of the usage context, we realized we had focused too much on creating and running workshops. This approach proved incomplete.",
