...
import { createAccountSession, normalizeEmail, verifyPassword } from '../../../server/lib/accountAuth.js'
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (error) {
    console.error('[auth/client/login] select app_accounts failed', error)
