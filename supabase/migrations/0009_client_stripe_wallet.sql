-- Stripe Customer + portefeuille passager (recharge CB)
...
comment on column public.client_profile_data.stripe_customer_id is 'Stripe Customer (cus_…) pour cartes enregistrees et recharges.';
comment on column public.client_profile_data.wallet_balance_cents is 'Solde portefeuille passager en centimes EUR.';
